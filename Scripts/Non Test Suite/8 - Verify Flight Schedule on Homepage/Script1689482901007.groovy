...
WebUI.click(findTestObject('SIACargo Website/Flight Schedule/Flight Schedule'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('SIACargo Website/Flight Schedule/Flight Schedule Active'), 0)

WebUI.scrollToElement(findTestObject('SIACargo Website/Flight Schedule/Flight Schedule Active'), 0)
