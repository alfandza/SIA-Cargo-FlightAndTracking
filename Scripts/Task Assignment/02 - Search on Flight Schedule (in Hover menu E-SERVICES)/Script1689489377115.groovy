...
String webCheck = WebUI.getUrl()

if (webCheck != 'https://www.siacargo.com/e-services/flightschedule_public/') {
    CustomKeywords.'siacargo.siacargokeyword.clickFlightSchedulePage'()
} else {
    WebUI.scrollToElement(findTestObject('SIACargo Flight Schedule/Page_Flight Schedule  Singapore Airlines Ca_b65577/Search Scrolling View'), 
        5)

    WebUI.delay(2)

    WebUI.click(findTestObject('Object Repository/SIACargo Flight Schedule/Page_Flight Schedule  Singapore Airlines Ca_b65577/Reset or New Search'))
}

WebUI.comment('This variable using standard in document')
